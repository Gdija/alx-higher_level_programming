...
DROP TABLE IF EXISTS hbtn_0d_tvshows.`tv_genres`;
...
DROP TABLE IF EXISTS hbtn_0d_tvshows.`tv_shows`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE hbtn_0d_tvshows.`tv_shows` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES hbtn_0d_tvshows.`tv_shows` WRITE;
